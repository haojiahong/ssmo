...
<link href="${pageContext.request.contextPath}/cssstyle/blog/style.css" rel="stylesheet" type="text/css" media="all" id="main-css">
<meta charset="UTF-8">
   ...
   <div class="textwidget"> 
    <ul class="widget_tags_inner"> 
    	<c:forEach items="${friendList}" var="friend">
   			<li><a href="http://${friend.friendUrl}" target="_blank" class="fr_link">${friend.friendName}</a></li> 
   		</c:forEach>
    </ul> 
   </div>
  </div>
