...
<link rel="icon" href="${pageContext.request.contextPath}/cssstyle/ico/myico.ico" type="image/x-icon" />
<link rel="shortcut icon" href="${pageContext.request.contextPath}/cssstyle/ico/myico.ico" type="image/x-icon" />
...
<!-- 配置文件 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/ueditor1_4_3/ueditor.config.js"></script>
<!-- 编辑器源码文件 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/ueditor1_4_3/ueditor.all.js"></script>
...
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/jslib/jquery-plugins/chosen/chosen.jquery.js"></script>
