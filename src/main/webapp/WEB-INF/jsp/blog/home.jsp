...
<html>
<head>
<link href="${pageContext.request.contextPath}/cssstyle/blog/style.css"
	rel="stylesheet" type="text/css" media="all" id="main-css">
<meta charset="UTF-8">
...
<body id="contain" class="home blog ui-c3">
	<section class="container">
		...
		<header class="header">
			...
			<h1 class="logo">
				<a href="http://www.coriger.com" title="乱七八糟">乱七八糟</a>
			</h1>
			<ul class="nav">
				...
				<ul class="widget_tags_inner">
					<c:forEach items="${tagList}" var="tag">
						<li><a title="" href="javascript:void(0)"
							onclick="goTag('${tag.id}')">${tag.tagName}</a></li>
					</c:forEach>
				</ul>
			</div>
				...
				<div class="textwidget">
					<ul class="widget_tags_inner">
						<c:forEach items="${friendList}" var="friend">
							<li><a href="http://${friend.friendUrl}" target="_blank"
								class="fr_link">${friend.friendName}</a></li>
						</c:forEach>
					</ul>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/article/article_list.js"></script>
	<script
